// Canonical URLs for LT Cervical IG - profiles and terminology
// Profile URLs: https://hl7.lt/fhir/cervical/StructureDefinition/{id}
// Terminology URLs: https://tx.hl7.lt/fhir/ (no -lt-cervical in path)

// === Profiles ===
Alias: $colposcopy-procedure-lt-cervical-url = https://hl7.lt/fhir/cervical/StructureDefinition/colposcopy-procedure-lt-cervical
Alias: $colposcopy-finding-lt-cervical-url = https://hl7.lt/fhir/cervical/StructureDefinition/colposcopy-finding-lt-cervical
Alias: $colposcopy-biopsy-procedure-lt-cervical-url = https://hl7.lt/fhir/cervical/StructureDefinition/colposcopy-biopsy-procedure-lt-cervical
Alias: $colposcopy-history-lt-cervical-url = https://hl7.lt/fhir/cervical/StructureDefinition/colposcopy-history-lt-cervical
Alias: $cytology-conclusion-lt-cervical-url = https://hl7.lt/fhir/cervical/StructureDefinition/cytology-conclusion-lt-cervical
...
// === Terminology (tx.hl7.lt, no -lt-cervical in path) ===
Alias: $cervix-score-lt-cervical-url = https://tx.hl7.lt/fhir/CodeSystem/cervix-score
Alias: $colposcopy-adequacy-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/colposcopy-adequacy
Alias: $colposcopy-swede-risk-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/colposcopy-swede-risk
Alias: $colposcopy-procedure-type-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/colposcopy-procedure-type
Alias: $cervical-biopsy-site-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/cervical-biopsy-site
Alias: $cytology-conclusion-vs-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/cytology-conclusion
Alias: $cytology-preparation-method-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/cytology-preparation-method
Alias: $hpv-genotype-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/hpv-genotype
Alias: $hpv-test-result-vs-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/hpv-test-result
Alias: $hpv-risk-group-lt-cervical-url = https://tx.hl7.lt/fhir/CodeSystem/hpv-risk-group
Alias: $hpv-risk-group-vs-lt-cervical-url = https://tx.hl7.lt/fhir/ValueSet/hpv-risk-group
