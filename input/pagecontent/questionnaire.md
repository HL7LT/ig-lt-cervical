...
| Pathological Diagnosis | Structured diagnosis coding (VLK, ICD-10, ICD-O, SNOMED CT) | [Questionnaire](Questionnaire-questionnaire-cervical-pathological-diagnosis-espbi.html) / [Response](QuestionnaireResponse-qr-cervical-path-diag-espbi-example.html) |
