...
//* component[hormoneTherapy].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (required)
...
//* component[lactation].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (required)
...
//* component[radiotherapy].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (preferred)
...
//* component[chemotherapy].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (preferred)
...
//* component[iud].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (required)
...
//* component[iudHormonal].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (required)
...
//* component[conization].valueCodeableConcept from http://hl7.org/fhir/ValueSet/yesnodontknow (preferred)
