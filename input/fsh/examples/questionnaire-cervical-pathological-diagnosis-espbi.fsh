...
* item[=].item[=].answerOption[+].valueCoding = $sct#1157177004 "Human papillomavirus-associated adenocarcinoma (morphologic abnormality)"
...
* item[=].item[=].answerOption[+].valueCoding = $sct#1228959009 "American Joint Committee on Cancer pT1a (qualifier value)"
...
* item[=].item[=].answerOption[+].valueCoding = $sct#1228962007 "American Joint Committee on Cancer pT1b (qualifier value)"
...
* item[=].item[=].answerOption[+].valueCoding = $sct#1229852009 "American Joint Committee on Cancer pT2 (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229853004 "American Joint Committee on Cancer pT2a (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229856007 "American Joint Committee on Cancer pT2b (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229859000 "American Joint Committee on Cancer pT3 (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229860005 "American Joint Committee on Cancer pT3a (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229861009 "American Joint Committee on Cancer pT3b (qualifier value)"
* item[=].item[=].answerOption[+].valueCoding = $sct#1229864001 "American Joint Committee on Cancer pT4 (qualifier value)"
