...
This page lists all ValueSets and CodeSystems defined in the Lithuanian Cervical Cancer IG.
...
| ValueSet | Description |
|---------|-------------|
| [CervicalHistopathologyDiagnosisVS](ValueSet-cervical-histopathology-diagnosis.html) | WHO classification diagnoses for cervical tissue (normal, CIN1–3, SCC, AIS, AC variants) |
| [CervicalHistologicalGradeVS](ValueSet-cervical-histological-grade.html) | AJCC histological grades (G1–G3, GX) |
| [CervicalSurgicalMarginsVS](ValueSet-cervical-surgical-margins.html) | Surgical margin status (clear, involved, cannot assess) |
| [CervicalTnmPtVS](ValueSet-cervical-tnm-pt.html) | Pathological primary tumor stage (pTX–pT1b2) |
| [CervicalTnmPrVS](ValueSet-cervical-tnm-pr.html) | Residual tumor classification (pRX–pR2) |
